...
image = nova.images.find(name="group9snap1")
...
if private_net != None:
    ...
    #CHANGE to cloud config file path
cfg_file_path = '/home/varco/project/cloud-cfg.txt'
...
instance = nova.servers.create(name="group_9", key_name=key, image=image, flavor=flavor, userdata=userdata, nics=nics,security_groups=secgroups)
